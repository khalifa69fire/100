...
logo = ("""
      ...
      \x1b[37;41m\t WELLCOME ASSALAMU ALAIKUM\x1b[0;m\n\n\x1b[1;37m                          
\33[1;37m----------------------------------------------
→   Owner      : EMON KHAN ALIF
→   Facebook   :  BLANK 
→   Github     : LAGBO NA
→   Tool Type  :  FREE VIP
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('espeak -a 200 "Welcome , ALIF , RENDOM , Clone"')
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ALIF]")
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        os.system('espeak -a 200 "Random , cloning , Started , ALIF"')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mALIF🔥\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
